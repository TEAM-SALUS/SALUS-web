...
@Component({
  selector: 'app-c-edit-medico',
  templateUrl: './c-edit-medico.component.html',
  styleUrls: ['./c-edit-medico.component.css'],
})
export class CEditMedicoComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.modalService.medicoEditar.unsubscribe;
  }
  ...
  private obtenerMedico() {
    this.modalService.medicoEditar.subscribe({
      next: (medicoData) => {
