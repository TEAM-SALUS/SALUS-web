...
@Component({
  selector: 'app-c-edit-paciente',
  templateUrl: './c-edit-paciente.component.html',
  styleUrls: ['./c-edit-paciente.component.css'],
})
export class CEditPacienteComponent implements OnInit, OnDestroy {
  ...
  private obtenerPaciente() {
    this.modalService.pacienteEditar.subscribe({
      next: (pacienteData) => {
  ...
  /** @description Obtiene usario default en formulario*/
