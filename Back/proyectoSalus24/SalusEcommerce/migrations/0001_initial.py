    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(blank=True, choices=[('Concluido', 'Concluido'), ('Rechazado', 'Rechazado'), ('Pendiente', 'Pendiente')], default='Rechazado', max_length=45)),
                ('obra_social', models.CharField(blank=True, max_length=150)),
            ],
            options={
                'verbose_name': 'Turno',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.turnosdisponibles'),
        ),
        migrations.AddConstraint(
            model_name='medico',
        ...
        migrations.AddConstraint(
            model_name='paciente',
            constraint=models.UniqueConstraint(fields=('pacienteUser',), name='Uk_Paciente_user'),
        ),
        migrations.AddConstraint(
            model_name='turnosdisponibles',
