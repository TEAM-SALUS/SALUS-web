...
>>>>>>> FeatureWebSprint1
=======
# Generated by Django 5.0.6 on 2024-05-27 03:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(default='especialidades/no-especialidad.jpg',
                 upload_to='especialidades', verbose_name='foto especialidad')),
                ('descripcion', models.CharField(
                    blank=True, default='lorem', max_length=254)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(default='medico/perfil/no-medic-img.jpg',
                 upload_to='medico/perfil', verbose_name='foto perfil medico')),
            ],
            options={
                'verbose_name': 'Medico',
...
<<<<<<< HEAD
<<<<<<< HEAD
                ('foto', models.ImageField(default='paciente/perfil/no-img.png',
                 upload_to='paciente/perfil', verbose_name='foto perfil paciente')),
=======
<<<<<<< HEAD
=======
                ('foto', models.ImageField(default='paciente/perfil/no-img.png',
...
>>>>>>> desarrolladorJEOrellano
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(blank=True, choices=[('Rechazado', 'Rechazado'), (
                    'Aceptado', 'Aceptado'), ('Pendiento', 'Pendiento')], default='Rechazado', max_length=45)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(blank=True, choices=[('Concluido', 'Concluido'), (
                    'Rechazado', 'Rechazado'), ('Pendiento', 'Pendiento')], default='Rechazado', max_length=45)),
            ],
            options={
                'verbose_name': 'Turno',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.especialidad'),
        ),
        migrations.AddField(
            model_name='medico',
            name='id_horario',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.horariodeatencion'),
        ),
        migrations.AddField(
            model_name='medico',
            name='medicoUser',
        ...
        migrations.AddField(
            ...
            name='id_medico',
            field=models.ForeignKey(
                default=-1, on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.medico'),
        ),
        migrations.AddField(
            model_name='turno',
            name='id_paciente',
            field=models.ForeignKey(
                default=-1, on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.paciente'),
        ),
        migrations.AddField(
            model_name='registrodeconsulta',
            name='id_turno',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.turno'),
        ),
        migrations.AddField(
            model_name='pago',
            name='id_turno',
            field=models.ForeignKey(
                default=-1, on_delete=django.db.models.deletion.CASCADE, to='SalusEcommerce.turno'),
        ),
        migrations.AddConstraint(
            model_name='medico',
            constraint=models.UniqueConstraint(
                fields=('matricula',), name='Uk_Medico'),
        ),
        migrations.AddConstraint(
            model_name='paciente',
            constraint=models.UniqueConstraint(
