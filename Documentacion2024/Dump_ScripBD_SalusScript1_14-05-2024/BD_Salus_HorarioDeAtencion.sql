...
--
-- Table structure for table `HorarioDeAtencion`
--

DROP TABLE IF EXISTS `HorarioDeAtencion`;
...
CREATE TABLE `HorarioDeAtencion` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Uk_HorarioDeAtencion` (`dia_de_la_semana`,`hora_entrada`,`hora_salida`)
